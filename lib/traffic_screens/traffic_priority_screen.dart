                ...
                child: Column(
                  ...
                  children: [
                    decisionLogEntry(
                      Icons.speaker_phone,
                      Colors.red,
                      "Ambulance detected with siren active, giving highest priority.",
                      "2 seconds ago",
                    ),
                    Divider(height: 20),
                    decisionLogEntry(
                      Icons.bus_alert,
                      Colors.orange,
                      "Bus delay threshold exceeded – elevating priority.",
                      "15 seconds ago",
                    ),
                    Divider(height: 20),
                    decisionLogEntry(
                      Icons.school,
                      Colors.amber,
                      "School bus approaching intersection during school hours.",
                      "1 minute ago",
                    ),
                  ],
                ),
