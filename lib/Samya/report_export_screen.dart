          ...
          children: [
            ...
            SingleChildScrollView(
              ...
              child: Row(
                children: [
                  quickReportCard(
                    "Violation Summary",
                    "Daily overview of traffic violations and infractions",
                    "2h ago",
                    Icons.warning,
                    Colors.orange,
                  ),
                  quickReportCard(
                    "Accident Analysis",
                    "Comprehensive accident reports and statistics",
                    "1h ago",
                    Icons.car_crash,
                    Colors.redAccent,
                  ),
                  quickReportCard(
                    "Carbon Report",
                    "Environmental impact and emissions data",
                    "30m ago",
                    Icons.eco,
                    Colors.green,
                  ),
            ...
            Row(
              ...
              children: [
                ...
                SizedBox(width: 12),
                exportButton("PNG", Colors.yellow),
              ],
            ),
            SizedBox(height: 24),
            // Scheduled Reports
      ...
      child: Column(
        ...
        children: [
          Row(
            ...
            children: [
              Container(width: 250, child: dropdownField("Select Metrics")),
              SizedBox(width: 12),
              Container(width: 250, child: textField("Date Range")),
              SizedBox(width: 12),
              Container(width: 250, child: dropdownField("Zone")),
            ],
          ),
          SizedBox(height: 16),
          Container(
